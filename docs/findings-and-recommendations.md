...
All 4 instrumented users passed through every step of the outfit creation funnel with zero drop-off. The 2 non-instrumented participants self-reported completing the same loop, giving 6/6 overall.
